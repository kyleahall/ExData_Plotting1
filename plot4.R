...
# Open a 2x2 PNG device named plot4.png
png('plot4.png', bg = 'transparent')
par(mfrow = c(2,2))

# Add a line chart of Global Active Power over time in the top left chart
plot(epcdata$dtime, epcdata$Global_active_power, ylab = 'Global Active Power (killowatts)', 
     xlab = "", type = "l")

# Add a voltage vs. datetime chart in the top right chart
plot(epcdata$dtime, epcdata$Voltage, ylab = 'Voltage', xlab = 'datetime', type = "l")

# Add a line chart of Global Active Power over time in the lower left chart
...
legend("topright", names(epcdata)[7:9], col=c("black", "red", "blue"), lty = 1, bty = "n")

# Add a line chart of global active power vs. date in the lower right chart
plot(epcdata$dtime, epcdata$Global_reactive_power, ylab = 'Global_reactive_power', 
